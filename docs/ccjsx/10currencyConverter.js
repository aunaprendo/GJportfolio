...
export function CurrencyConverter() {
  ...
  const convertedAmount = fromAmount * currencyMapping[moneyTo];
    ...
    <>
      <div className="converterPage">
        <div className="convertWindow">
          ...
          <h2>
            {moneyFrom} to {moneyTo} Conversion
          </h2>
          <input
            type="number"
            required
          ...
          <div className="field">
            ...
            <select id="moneyFrom" value={moneyFrom} onChange={(e) => setMoneyFrom(e.target.value)}>
          ...
          <div className="field">
            ...
            <select id="moneyTo" value={moneyTo} onChange={(e) => setMoneyTo(e.target.value)}>
              <option value="USD">USD</option>
              <option value="EUR">EUR</option>
              <option value="GBP">GBP</option>
              <option value="JPY">JPY</option>
